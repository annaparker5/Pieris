...
```{r}
NC1Larval <- NC1Larval %>% select(Treatment=Mean.Temp, DaysHtoP=Time.pupa, DaysPtoE=Time.eclose, Pupate.ok=PupateOk, Eclose.ok=EcloseOk, Mass.adult, Surv.eclose)
NC1Larval$Population <- "NC"
NC2Larval <- NC2Larval %>% select(Treatment=Mean.temp, DaysHtoP=Time.pupa, DaysPtoE=Time.eclose, Pupate.ok, Eclose.ok, Mass.adult, Surv.eclose)
NC2Larval$Population <- "NC"
CALarval <- CALarval %>% select(Treatment=Mean.temp, DaysHtoP=Time.pupa, DaysPtoE=Time.eclose, Pupate.ok, Eclose.ok, Mass.adult, Surv.eclose=Surv.adult)
CALarval$Population <- "CA"
WA1Larval <- WA1Larval %>% select(Treatment, DaysHtoP, DaysPtoE, Mass.larvapupa.int, Instar.dead, Mass.adult)
WA1Larval$Population <- "WA"
WA2Larval <- WA2Larval %>% select(Treatment, DaysHtoP, DaysPtoE, Mass.larvapupa.int, Instar.dead, Mass.adult)
...
```{r}
WA1Larval <- WA1Larval %>% select(Treatment, DaysHtoP, DaysPtoE, Pupate.ok, Eclose.ok, Mass.adult, Surv.eclose, Population)

WA2Larval <- WA2Larval %>% select(Treatment, DaysHtoP, DaysPtoE, Pupate.ok, Eclose.ok, Mass.adult, Surv.eclose, Population)
```
