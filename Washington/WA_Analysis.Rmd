...
```{r}
surveclosgraph <- ggplot(data = survdataeclos, aes(x = Treatment, y = surv.eclos.perc)) + 
  theme_bw() + 
  geom_point(size = 3) +
  scale_shape_manual(values = c(0, 2)) + 
  geom_line() + 
...
```{r}
ggsave("~/Desktop/GitHub/Pieris/Washington/FigsWA/survtoeclgraph.png", surveclosgraph, width = 8, height = 5)
```
