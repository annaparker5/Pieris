...
predictions <- augment(fitmodgauss, newdata = temprange)
...
# 3. Getting the final dev rate curve 
...
```{r}
april <- april[april$V7 == 0, ]
august <- august[august$V7 == 0, ]
```

```{r}
apriltemps <- tibble(Mean.Temp = april$V1) ## Needs to be the same column name as in the model object

augusttemps <- tibble(Mean.Temp = august$V1)
```
